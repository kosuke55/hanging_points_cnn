...
parser.add_argument(
    ...
    # default='/media/kosuke55/SANDISK-2/meshdata/shapenet_hanging_render/1014/shapenet_2000perobj_1020.pt') # shapenet hanging # noqa
...
parser.add_argument(
    ...
    default='eval_gan')
    # default='without_domain_randomization')
parser.add_argument(
